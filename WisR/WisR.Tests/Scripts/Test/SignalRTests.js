...
describe("SignalR Tests", function () {
    ...
    describe("Home controller", function () {
        ...
        it('should add one room to rooms', function () {
            ...
            spyOn(scope, "spawnNotification");
            shouldBeAdded = jasmine.createSpy();
    ...
    describe("Room controller", function () {
        ...
        it('should delete question, not the specificQuestion', function () {
            scope.Questions = [{ _t: "MultipleChoiceQuestion", _id: "562e3b88c7f56237b8652b49", RoomId: "560e66bc16d23936284bf130", CreatedById: "NoUser", Votes: [0], Img: "R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", QuestionText: "askldjk", ResponseOptions: [{ Value: "adsa", Weight: 0 }, { Value: "dsadasd", Weight: 0 }], Result: [0], CreationTimestamp: "1445870472559", ExpireTimestamp: "1473258372559" }];
            scope.SpecificQuestion = { _id: "562e3b88c7f56237adsb8652b49" }
        ...
        it('should delete question, the specificQuestion', function () {
            scope.Questions = [{ _t: "MultipleChoiceQuestion", _id: "562e3b88c7f56237b8652b49", RoomId: "560e66bc16d23936284bf130", CreatedById: "NoUser", Votes: [0], Img: "R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", QuestionText: "askldjk", ResponseOptions: [{ Value: "adsa", Weight: 0 }, { Value: "dsadasd", Weight: 0 }], Result: [0], CreationTimestamp: "1445870472559", ExpireTimestamp: "1473258372559" }];
            scope.SpecificQuestion = { _id: "562e3b88c7f56237b8652b49" }
            scope.SpecificQuestionShown = true;
        ...
        it('should throw you out of current room', function() {
            scope.CurrentRoom._id = "200";
            window.location.href = "http://localhost:7331/Room?RoomId=560e66bc16d23936284bf130";

            $.connection.roomHub.client.broadcastDeleteRoom("200");
