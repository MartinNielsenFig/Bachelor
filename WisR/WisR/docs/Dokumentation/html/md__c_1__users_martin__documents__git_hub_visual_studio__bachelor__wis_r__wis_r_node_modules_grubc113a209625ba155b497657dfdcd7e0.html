...
<title>WisR web applikation: minimatch</title>
...
<p><a href="http://travis-ci.org/isaacs/minimatch">![Build Status](https://secure.travis-ci.org/isaacs/minimatch.png)</a></p>
...
<h2>Usage</h2>
<div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;var minimatch = require(&quot;minimatch&quot;)</div>
<div class="line"><a name="l00002"></a><span class="lineno">    2</span>&#160;</div>
<div class="line"><a name="l00003"></a><span class="lineno">    3</span>&#160;minimatch(&quot;bar.foo&quot;, &quot;*.foo&quot;) // true!</div>
<div class="line"><a name="l00004"></a><span class="lineno">    4</span>&#160;minimatch(&quot;bar.foo&quot;, &quot;*.bar&quot;) // false!</div>
<div class="line"><a name="l00005"></a><span class="lineno">    5</span>&#160;minimatch(&quot;bar.foo&quot;, &quot;*.+(bar|foo)&quot;, { debug: true }) // true, and noisy!</div>
...
<div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;var Minimatch = require(&quot;minimatch&quot;).Minimatch</div>
<div class="line"><a name="l00002"></a><span class="lineno">    2</span>&#160;var mm = new Minimatch(pattern, options)</div>
...
<div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;var isJS = minimatch(file, &quot;*.js&quot;, { matchBase: true })</div>
</div><!-- fragment --><h3>minimatch.filter(pattern, options)</h3>
<p>Returns a function that tests its supplied argument, suitable for use with <code>Array.filter</code>. Example:</p>
<div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;var javascripts = fileList.filter(minimatch.filter(&quot;*.js&quot;, {matchBase: true}))</div>
</div><!-- fragment --><h3>minimatch.match(list, pattern, options)</h3>
...
<div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;var javascripts = minimatch.match(fileList, &quot;*.js&quot;, {matchBase: true}))</div>
</div><!-- fragment --><h3>minimatch.makeRe(pattern, options)</h3>
