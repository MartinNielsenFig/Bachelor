...
<title>WisR web applikation: combined-stream [![Build Status](https://travis-ci.org/felixge/node-combined-stream.svg?branch=master)](https://travis-ci.org/felixge/node-combined-stream)</title>
...
<h2>Installation</h2>
<div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;npm install combined-stream</div>
...
<div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;var CombinedStream = require(&#39;combined-stream&#39;);</div>
<div class="line"><a name="l00002"></a><span class="lineno">    2</span>&#160;var fs = require(&#39;fs&#39;);</div>
<div class="line"><a name="l00003"></a><span class="lineno">    3</span>&#160;</div>
<div class="line"><a name="l00004"></a><span class="lineno">    4</span>&#160;var combinedStream = CombinedStream.create();</div>
<div class="line"><a name="l00005"></a><span class="lineno">    5</span>&#160;combinedStream.append(fs.createReadStream(&#39;file1.txt&#39;));</div>
<div class="line"><a name="l00006"></a><span class="lineno">    6</span>&#160;combinedStream.append(fs.createReadStream(&#39;file2.txt&#39;));</div>
<div class="line"><a name="l00007"></a><span class="lineno">    7</span>&#160;</div>
<div class="line"><a name="l00008"></a><span class="lineno">    8</span>&#160;combinedStream.pipe(fs.createWriteStream(&#39;combined.txt&#39;));</div>
...
<div class="line"><a name="l00002"></a><span class="lineno">    2</span>&#160;var fs = require(&#39;fs&#39;);</div>
<div class="line"><a name="l00003"></a><span class="lineno">    3</span>&#160;</div>
<div class="line"><a name="l00004"></a><span class="lineno">    4</span>&#160;var combinedStream = CombinedStream.create({pauseStreams: false});</div>
<div class="line"><a name="l00005"></a><span class="lineno">    5</span>&#160;combinedStream.append(fs.createReadStream(&#39;file1.txt&#39;));</div>
<div class="line"><a name="l00006"></a><span class="lineno">    6</span>&#160;combinedStream.append(fs.createReadStream(&#39;file2.txt&#39;));</div>
<div class="line"><a name="l00007"></a><span class="lineno">    7</span>&#160;</div>
<div class="line"><a name="l00008"></a><span class="lineno">    8</span>&#160;combinedStream.pipe(fs.createWriteStream(&#39;combined.txt&#39;));</div>
...
<div class="line"><a name="l00003"></a><span class="lineno">    3</span>&#160;</div>
<div class="line"><a name="l00004"></a><span class="lineno">    4</span>&#160;var combinedStream = CombinedStream.create();</div>
<div class="line"><a name="l00005"></a><span class="lineno">    5</span>&#160;combinedStream.append(function(next) {</div>
<div class="line"><a name="l00006"></a><span class="lineno">    6</span>&#160;  next(fs.createReadStream(&#39;file1.txt&#39;));</div>
<div class="line"><a name="l00007"></a><span class="lineno">    7</span>&#160;});</div>
<div class="line"><a name="l00008"></a><span class="lineno">    8</span>&#160;combinedStream.append(function(next) {</div>
<div class="line"><a name="l00009"></a><span class="lineno">    9</span>&#160;  next(fs.createReadStream(&#39;file2.txt&#39;));</div>
<div class="line"><a name="l00010"></a><span class="lineno">   10</span>&#160;});</div>
<div class="line"><a name="l00011"></a><span class="lineno">   11</span>&#160;</div>
<div class="line"><a name="l00012"></a><span class="lineno">   12</span>&#160;combinedStream.pipe(fs.createWriteStream(&#39;combined.txt&#39;));</div>
