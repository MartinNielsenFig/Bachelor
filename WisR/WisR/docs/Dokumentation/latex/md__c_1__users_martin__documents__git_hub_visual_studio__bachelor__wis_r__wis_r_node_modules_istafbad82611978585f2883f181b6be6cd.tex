\href{http://travis-ci.org/nodeca/argparse}{\tt !\mbox{[}Build Status\mbox{]}(https\+://secure.\+travis-\/ci.\+org/nodeca/argparse.\+png?branch=master)} \href{https://www.npmjs.org/package/argparse}{\tt !\mbox{[}N\+P\+M version\mbox{]}(https\+://img.\+shields.\+io/npm/v/argparse.\+svg)}

C\+L\+I arguments parser for node.\+js. Javascript port of python\textquotesingle{}s \href{http://docs.python.org/dev/library/argparse.html}{\tt argparse} module (original version 3.\+2). That\textquotesingle{}s a full port, except some very rare options, recorded in issue tracker.
