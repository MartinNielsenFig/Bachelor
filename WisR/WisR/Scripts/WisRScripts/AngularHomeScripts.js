 ...
 * @description
 * Controller for the Home View of the website
 */
app.controller("HomeController", [
    '$scope', '$http', '$location', '$window', 'configs', function ($scope, $http, $location, $window, configs) {
         ...
         * @propertyOf dashboard.controller:HomeController 
        ...
        */
        ...
        $(function () {
            ...
            * @methodOf dashboard.controller:HomeController
            *
            * @description
      ...
      * At this point the function calls geocode to get the formatted address of the location.
      */
